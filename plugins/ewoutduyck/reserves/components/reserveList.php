<?php namespace ewoutduyck\reserves\Components;

use Lang;
use Cms\Classes\Page;
use Rainlab\Builder\Components\RecordList;
use RainLab\Builder\Classes\ComponentHelper;
use ewoutduyck\reserves\model\Reserve as Reserve;
use SystemException;
use Exception;

class ReserveList extends RecordList
{
    /**
    ...
    protected function getLocations($model)
    {
        $locations = Reserve::select('coordinates')->get();
